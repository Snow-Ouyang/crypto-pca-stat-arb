...
def write_report() -> None:
    ...
    lines = [
        ...
        "",
        "Advanced PCA fixes residual-comovement penalty `0.5`; ordinary PCA uses equal-weight dollar-neutral sleeves, and advanced PCA uses portfolio soft beta lambda `3`. Positions are force-closed when the ticker leaves the no-lookahead universe.",
        "",
